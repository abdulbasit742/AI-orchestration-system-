...
These instructions apply to the entire `abdulbasit742/AI-orchestration-system-` repository. More specific AGENTS.md or AGENTS.override.md files in subdirectories may refine them.

Project: **AI-orchestration-system-**.
